  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Generate Payslip">
        <div className="space-y-4"><div><label className="block text-sm font-medium text-neu-text mb-1">Employee</label><select value={form.employee_id}onChange={(e)=>{
